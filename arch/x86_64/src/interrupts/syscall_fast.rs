...
/// Fast SYSCALL/SYSRET handler
///
/// This handler is called from the SYSCALL/SYSRET entry stub and is optimized
/// for the fast path where no context switch is needed.
#[unsafe(no_mangle)]
extern "C" fn serviceos_x86_64_handle_syscall_fast(frame: &mut SavedUserContext) -> u64 {
