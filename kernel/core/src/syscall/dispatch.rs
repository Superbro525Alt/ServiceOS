...
use super::{
    ...
    handle_memory_read, handle_memory_write, handle_monotonic_now, handle_object_info,
...
pub fn initialize() -> &'static DispatchTable {
    DISPATCHER.call_once(|| {
        DispatchTable::new([
            ...
            Some(handle_kernel_event_query_info),
            Some(handle_kernel_event_query_record),
        ])
    })
}
